...
public class MenuScrollView extends HorizontalScrollView {
    ...
    public static MenuScrollView selectMyScrollView ;
    ...
    private static class MyScrollHandler extends Handler{
        public void handleMessage(Message msg) {
            ...
            int nowS = msg.what;
            MenuScrollView myScrollView = (MenuScrollView) msg.obj;
    ...
    static class MyEndScrollRunnable implements Runnable{
        ...
        public MenuScrollView mScrollView;

        public MyEndScrollRunnable(MenuScrollView mScrollView, int left, int end){
            this.nowLeft = left;
            this.end = end;
